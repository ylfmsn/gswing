...
import com.suntoon.event.MapMouseAdapter;
import com.suntoon.event.MapMouseEvent;
import com.suntoon.event.MapPaneAdapter;
import com.suntoon.event.MapPaneEvent;
...
public class JCoordsStatusBarItem extends StatusBarItem {
	...
	private static final String COMPONENT_NAME = "CoordsItemName";
    
    private static final String TOOL_TIP = "CoordsTooltip";
    private static final int DEFAULT_NUM_INTEGER_DIGITS = 3;

    private static final String NO_COORDS = "CoordsNone";
